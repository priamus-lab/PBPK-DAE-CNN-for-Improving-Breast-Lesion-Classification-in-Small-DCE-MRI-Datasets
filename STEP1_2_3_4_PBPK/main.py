...
pathResult_train = basePath+'Results/STEP_PBPK_FINAL_Version/DAE_CNN_STEP1_2_3_4_' + net_name + '/TRAIN_LOOP/Fold'+str(fold) + '/' #ci mettiamo i pesi nel corso degli addestramenti->ci sono i pesi migliori e quelli di ogni epoca
pathResult_final = basePath+'Results/STEP_PBPK_FINAL_Version/DAE_CNN_STEP1_2_3_4_' + net_name + '/FINAL_LOOP/Fold'+str(fold) + '/' #ci mettiamo i pesi nel riaddestramento -> pesi di ogni epoca del riaddestramento
